                  ...
                  child: Column(
                    ...
                    children: [
                      FeatureItem(
                        ...
                        text: 'Unlimited AI Video',
                      ),
                      SizedBox(height: 16.h),
                      FeatureItem(icon: Icons.high_quality, text: '4K Quality'),
                      SizedBox(height: 16.h),
                      FeatureItem(
                        icon: Icons.flash_on,
                  ...
                  child: Column(
                    children: [
                          ...
                          children: [
                            Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  ref
                                      .read(subscriptionTypeProvider.notifier)
                      ...
                      plans[selectedSubscription] != null
                          ? SubscriptionCard(plan: plans[selectedSubscription]!)
                          : Container(
                              height: 200.h,
                              child: const Center(
                                child: Text(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12.r),
            border: Border.all(color: AppColors.electricBlue, width: 1.5.w),
          ),
          child: Icon(icon, color: AppColors.electricBlue, size: 20.sp),
        ),
        SizedBox(width: 16.w),
        Expanded(
          child: Text(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: plan.isPopular ? AppColors.electricBlue : AppColors.neonPurple,
          width: 2.w,
        ),
        boxShadow: [
          BoxShadow(
